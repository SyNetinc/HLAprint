                ...
                <div>
                    <div class="settings position-relative " style="display: block !important;">
                        ...
                        <div class="d-flex options">
                            <p><img src="{{ asset('public/assets/english') }}/img/color.png" style="width: 3.8rem;" alt=""> Color:</p>
                        ...
                        <div class="d-flex options">
                            <p><img src="{{ asset('public/assets/english') }}/img/sides.png" style="width: 3.2rem;" alt=""> Sides:</p>
                            <div class="d-flex fle-column">
                        ...
                        <div class="d-flex options">
                            <p><img src="{{ asset('public/assets/english') }}/img/range.png" style="width: 3.3rem;" alt=""> Range:</p>
                            <div class="d-flex fle-column">
                            <div class="d-flex input">
                        ...
                        <div class="d-flex Pages">
                            <div class="d-flex justify-content-center align-items-center">
                                <p style="margin-right: 8.1rem; margin-left: 0"><img style="width: 2.8rem;" src="{{ asset('public/assets/english') }}/img/copies.png" alt="">
                                    Copies:</p>
                                <div class="position-relative d-flex align-items-center">
                                    <p style="user-select: none; cursor: pointer; margin: 0 !important; padding: 0; font-size: 25px; font-weight: 500; transform: rotate(180deg);"
